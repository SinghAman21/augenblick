      ...
      <div className="p-6 lg:p-8 max-w-xl">
        ...
        <div className="space-y-5">
          <div className="space-y-1.5">
            ...
            <Input placeholder="e.g. Q2 Product Roadmap" className="bg-card border-border" />
          </div>
          <div className="space-y-1.5">
            <Label className="text-xs text-mono uppercase tracking-wider text-muted-foreground">Description</Label>
            <Textarea placeholder="What will you brainstorm about?" className="bg-card border-border min-h-[90px]" />
          </div>
          <div className="space-y-1.5">
          ...
          <Link to="/session/1">
            <button className="btn-primary flex items-center gap-2 w-full justify-center mt-2">
